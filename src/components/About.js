           ...
           <div className="grid md:grid-cols-2 gap-5">
                ...
                <div className="">
                    <div data-aos="zoom-in" data-aos-duration="2000" className="flex flex-col gap-4 tracking-wide">
                        ...
                        <p>I am a web developer. I am a punctual and motivated individual who is able to work in a busy environment and produce hight standards of work.</p>
                        ...
                        <div className="grid text-[14px] gap-5 *:flex *:items-center *:gap-2 *:px-1*:rounded-lg tracking-wider">
