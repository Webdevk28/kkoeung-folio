        ...
        <section className="r-side mt-10 px-5 py-10">
           <div className="grid md:grid-cols-2 gap-5">
                <div className="hidden md:block">
                    <div data-aos="zoom-in" data-aos-duration="2000" ><img src={person} alt="person" className="opacity-10"/></div>
                </div>
                ...
                <div className="">
                    <div data-aos="zoom-in" data-aos-duration="2000" className="flex flex-col gap-4 tracking-wide">
                        ...
                        <span className="l-span">Web Developer & IT Supporter</span>
                        <p className="text-justify">I am a IT Support & Web Developer. I am a punctual and motivated individual who is able to work in a busy environment and produce hight standards of work.</p>
                        <p className="text-justify">I am an excellent team worker and am able to take instructions from all levels and build up good working relationships with all colleagues. I am flexible reliable and possesss excellent time keeping skills.</p>
                        ...
                        <div className="grid text-[14px] gap-3 mt-2 *:flex *:items-center *:gap-2 *:px-1*:rounded-lg tracking-wider">
                            ...
                            <div><div><FaTelegramPlane className="text-lg text-yellow-400"/></div> <a href="https://t.me/kkoeung27">https://t.me/kkoeung27</a></div>
                        </div>
                    </div>
                </div>
            </div>
